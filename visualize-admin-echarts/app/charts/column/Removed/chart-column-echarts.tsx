...
export const ChartColumnsVisualizationECharts = (
  props: VisualizationProps<ColumnConfig>
) => {
  return <ChartDataWrapper {...props} Component={ChartColumnsECharts} />;
};

const ChartColumnsECharts = memo((props: ChartProps<ColumnConfig>) => {
