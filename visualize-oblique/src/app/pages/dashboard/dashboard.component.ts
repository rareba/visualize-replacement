  ...
  template: `
    <div class="dashboard-page">
      ...
      <header class="page-header">
        <h1>Dashboard</h1>
        <p class="subtitle">
          Embedded Superset dashboard with interactive filters and visualizations.
        </p>
      </header>
      ...
      @if (!dashboardId()) {
        <mat-card class="error-card">
          <mat-card-content>
            ...
            <h3>Dashboard ID Required</h3>
            <p>Please provide a valid dashboard ID in the URL.</p>
        ...
        <mat-card class="info-banner">
          <mat-card-content>
            ...
            <span>
              <strong>Note:</strong> This dashboard is embedded from Apache Superset.
              Ensure Superset is running and the dashboard with ID <code>{{ dashboardId() }}</code> exists.
            </span>
          </mat-card-content>
        </mat-card>
