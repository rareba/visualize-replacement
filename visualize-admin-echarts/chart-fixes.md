...
### CF-02. Zoom slider breaks on empty/degenerate time domains
...
### CF-03. Combo tooltip formatters inject raw HTML and lack param validation
...
### CF-04. Donut tooltip/label param assertions can throw
...
### CF-05. Combo line+column adapter drops duplicate-category data and scales poorly
...
### CF-06. Combo line+column state assumes time unit always defined
...
### CF-07. Horizontal bar tooltip placement uses wrong anchor
...
### CF-08. Chart snapshots e2e spec doesn’t validate rendering output
