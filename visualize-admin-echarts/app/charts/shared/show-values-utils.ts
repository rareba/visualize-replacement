...
export const useShowBandValueLabelsVariables = (
  ...
  if (!measure) {
    console.warn(
      `No measure <${measureField?.componentId}> found in cube (useShowBandValueLabelsVariables). Value labels may not display.`
    );
  }
...
export const useShowTemporalValueLabelsVariables = (
  ...
  if (!yMeasure) {
    console.warn(
      `No measure <${y?.componentId}> found in cube (useShowTemporalValueLabelsVariables). Value labels may not display.`
    );
  }
