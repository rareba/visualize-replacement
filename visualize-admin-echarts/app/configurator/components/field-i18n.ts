...
const fieldLabels = {
  ...
  "controls.chart.type.donut": defineMessage({
    id: "controls.chart.type.donut",
    message: "Donut",
  }),
  "controls.chart.type.radar": defineMessage({
  ...
  "controls.chart.type.boxplot": defineMessage({
    id: "controls.chart.type.boxplot",
    message: "Boxplot",
  }),
  ...
  "controls.chart.category.basic": defineMessage({
    id: "controls.chart.category.basic",
    message: "Basic",
  }),
  "controls.chart.category.partOfWhole": defineMessage({
    id: "controls.chart.category.partOfWhole",
    message: "Part-of-Whole",
  }),
  "controls.chart.category.hierarchical": defineMessage({
    id: "controls.chart.category.hierarchical",
    message: "Hierarchical",
  }),
  "controls.chart.category.statistical": defineMessage({
    id: "controls.chart.category.statistical",
    message: "Statistical",
  }),
  "controls.chart.category.flow": defineMessage({
    id: "controls.chart.category.flow",
    message: "Flow",
  }),
  "controls.chart.category.specialized": defineMessage({
    id: "controls.chart.category.specialized",
    message: "Specialized",
  }),
  "controls.chart.category.comparison": defineMessage({
    id: "controls.chart.category.comparison",
    message: "Comparison",
  }),
...
export function getFieldLabel(field: string): string {
  switch (field) {
    ...
    case "controls.chart.category.partOfWhole":
      return i18n._(fieldLabels["controls.chart.category.partOfWhole"]);
    case "controls.chart.category.hierarchical":
      return i18n._(fieldLabels["controls.chart.category.hierarchical"]);
    case "controls.chart.category.statistical":
      return i18n._(fieldLabels["controls.chart.category.statistical"]);
    case "controls.chart.category.flow":
      return i18n._(fieldLabels["controls.chart.category.flow"]);
    case "controls.chart.category.specialized":
      return i18n._(fieldLabels["controls.chart.category.specialized"]);
    case "controls.chart.category.comparison":
      return i18n._(fieldLabels["controls.chart.category.comparison"]);
