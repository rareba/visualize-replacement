...
export const CHART_REGISTRY: Record<ChartType, ChartMetadata> = {
  ...
  bar3d: {
    ...
    order: 10,
    symbol: "square",
    labelKey: "chart.bar3d.title",
    descriptionKey: "chart.bar3d.description",
  ...
  scatter3d: {
    ...
    order: 11,
    symbol: "circle",
    labelKey: "chart.scatter3d.title",
    descriptionKey: "chart.scatter3d.description",
    iconName: "scatterplotChart",
    isCombo: false,
    minDimensions: 0,
    minMeasures: 2,
  ...
  surface: {
    ...
    order: 10,
    symbol: "square",
    labelKey: "chart.surface.title",
    descriptionKey: "chart.surface.description",
    iconName: "areasChart",
    isCombo: false,
    minDimensions: 2,
    minMeasures: 1,
  ...
  line3d: {
    ...
    order: 12,
    symbol: "line",
    labelKey: "chart.line3d.title",
    descriptionKey: "chart.line3d.description",
    iconName: "lineChart",
    isCombo: false,
    minDimensions: 1,
    minMeasures: 1,
  ...
  globe: {
    ...
    order: 10,
    symbol: "circle",
    labelKey: "chart.globe.title",
    descriptionKey: "chart.globe.description",
    iconName: "mapChart",
    isCombo: false,
    minDimensions: 1,
    minMeasures: 1,
  ...
  pie3d: {
    ...
    order: 10,
    symbol: "square",
    labelKey: "chart.pie3d.title",
    descriptionKey: "chart.pie3d.description",
    iconName: "pieChart",
    isCombo: false,
    minDimensions: 1,
    minMeasures: 1,
